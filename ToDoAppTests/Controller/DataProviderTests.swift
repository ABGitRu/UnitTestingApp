...
super.setUp()
    ...
    func testCellForRowAtIndexPathDequeuesCellFromTableView() {
        ...
        _ = mockTableView.cellForRow(at: IndexPath(
            row: 0,
            section: 0)
        )
...
extension DataProviderTests {
    ...
    class MockTableView: UITableView {
        ...
        static func mockTableView(
            WithDataSource dataSource: UITableViewDataSource) -> MockTableView {
                let mockTableView = MockTableView(frame: CGRect(x: 0, y: 0, width: 0, height: 0), style: .plain)
